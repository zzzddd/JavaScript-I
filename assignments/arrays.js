...
console.log(`Car 33 is a ${console.log(inventory[33].car_year)}
 ${console.log(inventory[33].car_make)}* *${console.log(inventory[33].car_model)}*`);
...
//  console.log(carModelsSorted);
 //carModels=inventory.map(car_model);
...
for(i=0;i<inventory.length; i++){
  if(inventory[i].car_year<2000) oldCars.push(carYears[i]);
  //carYears.push(inventory[i].car_year);
  // c=(carYears[i].car_year);
  // carYears.push(c);
}
...
let BMWAndAudi = [];
console.log();
//Object.values(myPersonalObject)

for(i=0;i<inventory.length; i++){
  if((inventory[i].car_make) === "Accord"){
  BMWAndAudi.push(inventory[i]);}
}
   // BMWAndAudi.push(inventory[i]);
  
   //console.log(Object.values(inventory[2].car_make) );
   //JSON.stringify(oldCars);
   //console.log(Object.values(JSON.stringify(inventory[2].car_make)) );
//   //carYears.push(inventory[i].car_year);
//   // c=(inventory[i].car_year);
//   // carYears.push(c);
// }
//console.log(inventory[0].car_make.toLowerCase());
// for (let i = 0; i < inventory.length; i++) {
//   BMWAndAudi.push(inventory[i].car_make === "BMW" || "Audi");
// }
